...
var map = new ol.Map({
    ...
    layers: layersList,
    view: new ol.View({
        extent: [4994335.748327, -1921111.685472, 5283163.389583, -1711969.402864], maxZoom: 28, minZoom: 1
    })
});

//initial view - epsg:3857 coordinates if not "Match project CRS"
map.getView().fit([4994335.748327, -1921111.685472, 5283163.389583, -1711969.402864], map.getSize());
...
var searchLayer = new SearchLayer({
    layer: lyr_Certificat_Andranoboka_4,
    colName: 'numerocert',
    zoom: 10,
    collapsed: true,
    map: map
